				...
				<div class="col-md-4">
					<div class="white-box">
						...
						<div class="login-logo" style="text-align: center">
							<img src="{!! asset('admin_assets/img/logo2.png') !!}" height="120" width="auto" style="margin-top: 25px"/>
						</div>
						{!! Form::open(['url' => 'login','class' => 'form-horizontal new-lg-form','id' => 'loginform']) !!}
							...
							<div class="form-group  m-t-20">
							  <div class="col-xs-12">
								<label>Email</label>
								  <input type="text" name="user_name" class="form-control" placeholder="Email " value="{!! old('user_name') !!}">
							  </div>
							</div>
